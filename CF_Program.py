...
from mutagen.id3 import APIC, COMM, ID3, TALB, TDRC, TIT2, TPE1, TPE2, TPOS, TRCK
...
secondary_map = { "%N": _get_track_number}
...
def get_all_mp3_as_obj(directory: str) -> list[Song]: 
    """
    Returns as Song objects all mp3 files from a directory.
    """
    p = Path(directory)
...
def process_new_tags(song: Song, song_data: (dict[str, str] | None) = None) -> None :
    ...
    new_filename = temp_filename + '.mp3'
